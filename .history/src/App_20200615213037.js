...
<div>
  <div>
    ...
    <div className="nav-extended light-green darken-1">
      <br></br>
    <div className="nav-extended white">
      <textarea className= "white" name="Introduce your city" onChange={this.handleChange} value={this.state.position} cols="30" rows="10" placeholder="Employee position" className="materialize-textarea"></textarea>
    </div>  
    </div>
</div>
