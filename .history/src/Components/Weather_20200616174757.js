      ...
      <div className="card light-green darken-1">
        <div className="card-body">
          <div className="location-box">
            ...
            <div className="location list-group-item">{weather.coord.lat}</div>
            <div className="location list-group-item">{weather.coord.lon}</div>
            ...
            <Map className="map" center={weather.coord.lat,weather.coord.lon} zoom={13}>
    <TileLayer
