...
<div>
  <div>
    ...
    <div className="nav-extended ">
      ...
      <textarea className= "white" name="city" onChange={this.handleChange} value={this.state.position} cols="30" rows="10"></textarea>
      <p className="text-white">Longitude</p>
      <textarea className= "white mb-2" name="city" onChange={this.handleChange} value={this.state.position} cols="30" rows="10"></textarea>
