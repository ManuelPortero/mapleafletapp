      ...
      <nav className="nav-extended light-blue darken-1">
              <div className="nav-wrapper">
                ...
                <ul  className="right hide-on-med-and-down">
                  <li className="tab"><a href="sass.html">City data</a></li>
                  <li className="tab"><a href="badges.html">Weather</a></li>
                  <li className="tab"><a href="collapsible.html">City Map</a></li>
                </ul>
              </div>
