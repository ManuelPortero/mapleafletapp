...
<div>
  <div>
    ...
    <div className="nav-extended white">
      <textarea className= "white" name="position" onChange={this.handleChange} value={this.state.position} cols="30" rows="10" placeholder="Employee position" className="materialize-textarea"></textarea>
    </div>  
    </div>
</div>
